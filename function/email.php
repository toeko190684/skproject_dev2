...
function simpanemail($from,$subject,$body,$header,$kode){
	$input = mysql_query("insert into email(from,subject,body,header,kode)
				values('$from','$subject','$body','$header','$kode')");
	if($input){ echo "berhasil"; }else{ echo "gagal";}
}
?>